...
- `server.json` file at repository root
...
The Docker MCP Community Registry accepts server submissions.
...
### 4.2 VS 2026 Direct Integration

VS 2026 can discover MCP servers directly from GitHub if the repository:
