...
**让 AI Agent 通过 MCP 协议原生控制 Visual Studio 2026/2022。**

---

## 🚀 为什么选择 .NET 原生方案？

| 特性 | Python (旧版) | .NET 原生 (新版) |
|------|--------------|------------------|
...
## 🔧 Visual Studio 2026 配置（3种方式）

### 方式 A：MCP Registry 一键安装（推荐）
...
5. VS 会自动发现 `server.json` 并列出可用服务器
6. 选择 `universal-vsmcp` 并点击安装
...
- [Visual Studio 2026 MCP 支持](https://learn.microsoft.com/en-us/visualstudio/)
